    ...
    <section className="relative min-h-screen px-6 py-20 flex flex-col justify-center items-center text-center bg-hero-gradient text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl">
        <h1 className="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight">
          ...
          <span className="text-accent">24/7 Growth Machine.</span>
        </h1>
        <p className="mt-6 text-lg md:text-xl text-gray-300">
          NoSleep Systems installs done-for-you systems powered by AI,
          automations, and psychological conversion frameworks — helping you
...
>
  Install My System →
      ...
      {/* Social Proof Block */}
      <div className="relative z-10 mt-16 max-w-xl text-sm text-gray-300 bg-white/5 backdrop-blur-md p-6 rounded-xl border border-white/10">
        <p className="mb-2 font-semibold text-white">
          Used by elite closers, consultants, and service businesses to:
        </p>
        <ul className="text-left space-y-1 pl-4 list-disc list-inside">
