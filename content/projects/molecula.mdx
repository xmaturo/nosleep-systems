...
MOLECULA achieves steeper roll-off in the 4–8 Hz range where human vibration sensitivity peaks. The transfer function crosses the ISO target threshold earlier and maintains greater attenuation at higher frequencies.
